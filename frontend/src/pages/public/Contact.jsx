            ...
            <div className="card p-6 space-y-4">
              ...
              <div className="flex gap-2">
                {[
                  ...
                  { icon: 'photo_camera', label: 'Instagram', href: contact.instagram },
                  { icon: 'work', label: 'LinkedIn', href: contact.linkedin },
                  { icon: 'smart_display', label: 'YouTube', href: contact.youtube },
                ].map((s) => (
