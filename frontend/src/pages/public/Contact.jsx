    ...
    <div className="flex flex-col">
      ...
      <section className="hero-bg py-20 px-6 text-center">
        <div className="max-w-3xl mx-auto space-y-4">
          ...
          <h1 className="font-heading font-bold text-white text-5xl">Get in <span className="text-primary">Touch</span></h1>
          <p className="text-primary-light/90 text-lg">We're here to help. Reach out through any channel and our team will respond promptly.</p>
        </div>
      </section>
        ...
        <div className="max-w-screen-xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-5">
            ...
            <div className="card p-6 space-y-4">
              <h3 className="font-heading font-semibold text-navy">Follow Us</h3>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    {[
                      ...
                      { name: 'phone', label: 'Phone / WhatsApp', type: 'tel', placeholder: '+93 700 000 000', required: false },
                  ...
                  <div>
                    <label className="block text-xs font-semibold tracking-widest uppercase text-text-muted mb-2">Preferred Service</label>
                  ...
                  <div>
                    <label className="block text-xs font-semibold tracking-widest uppercase text-text-muted mb-2">Message *</label>
