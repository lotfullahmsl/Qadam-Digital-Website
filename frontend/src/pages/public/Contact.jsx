        ...
        <div className="max-w-screen-xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-5">
            <div className="card p-6 space-y-5">
              ...
              {[
                { icon: 'chat', label: t('common.whatsapp'), value: '+92 303 939 3438', href: 'https://wa.me/923039393438' },
                { icon: 'email', label: t('common.email'), value: 'Qadamdigital.official@gmail.com', href: 'mailto:Qadamdigital.official@gmail.com' },
                { icon: 'phone', label: t('common.phone'), value: '+92 777 241 173', href: 'tel:+92777241173' },
